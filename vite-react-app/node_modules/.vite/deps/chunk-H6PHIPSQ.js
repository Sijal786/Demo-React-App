...
var _excluded31 = ["children", "className", "lastTransitionedPropertyOnEnter", "lastTransitionedPropertyOnExit", "enterClassName", "exitClassName"];
function CssTransition(props) {
  ...
  const [isEntering, setIsEntering] = React76.useState(!requestedEnter);
  React76.useEffect(() => {
    if (requestedEnter) {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-H6PHIPSQ.js.map

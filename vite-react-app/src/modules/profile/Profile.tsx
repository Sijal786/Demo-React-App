...
const Profile = () => {
  ...
  }, [isLoading, isError, data]); // handle cancel subscription
              ...
              >
                <CardContent style={{ flexGrow: "1" }}>
                  ...
                  <Typography variant="body1" color="textSecondary">
                    ...
                    was finalized. This represents the agreed-upon subscription
                    plan and outlines the details of the services provided.
                  </Typography>
                </CardContent>
                <CardActions>

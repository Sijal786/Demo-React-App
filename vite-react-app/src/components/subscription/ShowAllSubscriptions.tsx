                ...
                >
                  <CardContent style={{ flexGrow: "1" }}>
                    ...
                    <Typography variant="body1" color="textSecondary">
                      ...
                      {subscription.plan.currency} /{" "}
                      {subscription.plan.interval} to mahnoor.afzal@gmail.com
                      was finalized. This represents the agreed-upon
                      subscription plan and outlines the details of the services
                      provided.
                    </Typography>
                  </CardContent>
                  <CardActions>

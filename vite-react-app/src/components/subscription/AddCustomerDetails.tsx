  ...
  return (
    ...
    <ThemeProvider theme={defaultTheme}>
      <Container component="main" maxWidth="xs">
        ...
        {successStatus.isErrorAlert && <ShowAlert severity = {"error"} content = "User with this email and passowrd already existed" />}
        {successStatus.isSuccessAlert && <ShowAlert severity = {"success"} content = "The User is registered successfully"/>}
      </Container>
      {successStatus.isLoading && <Loading />}
      {showDialog && <ShowDialog title = "Sign In"  content = "Sign in to subscribe the offers "/>}
    </ThemeProvider>
  )
}
